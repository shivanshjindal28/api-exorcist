...
85 tests, ruff clean, mypy `--strict` clean. Optional extras: `.[stream]` for
...
src/apix/
  ...
  extractors/
    ...
    semgrep_extractor.py   AST route extraction; prefix composition
...
tests/                     85 tests, including three ground-truth leakage guards
